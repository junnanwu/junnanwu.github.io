...
- `&&`
  ...
  逻辑与，`命令1&&命令2`，当命令1正确执行，则命令2才会正常执行；当命令1执行不正确，命令2不会执行。

- `||`

  逻辑或，`命令1||命令2`，当命令1执行不正确，则命令2才会执行，当命令1执行正确，则命令2不会执行。
...
```
$ date
2022年 08月 31日 星期三 15:46:56 CST
```
...
1. 文章：[How to Use the rename Command on Linux](https://www.howtogeek.com/423214/how-to-use-the-rename-command-on-linux/)
1. 文章：[How to Find and Sort Files Based on Modification Date and Time in Linux](https://www.tecmint.com/find-and-sort-files-modification-date-and-time-in-linux/)
