...
![image-20210707210022896](前端assets/image-20210707210022896.png)

![1595523041514](前端assets/1595523041514.png)

![1595523050180](前端assets/1595523050180.png)
...
```html
    ...
    -->
    <!--相对路径-->
    <前端assets src="前端assets/2.jpg" height="200px" width="150px" title="我是一个美女"/>
    <前端assets src="前端assets/22.jpg" height="200px" width="150px" title="我是一个美女" alt="美女走丢了"/>

    <!--绝对路径-->
    <前端assets src="file:///D:/Work_idea/EE24/day31_html/前端assets/2.jpg" height="200px" width="150px" title="我是一个美女"/>
    
    <!--互联网上图片的地址-->
    <前端assets src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/t前端assets?image&quality=100&size=b4000_4000&sec=1595560972&di=a813018600a70e80dedc605d72c79920&src=http://n.sina前端assets.cn/sinacn18/110/w750h960/20180504/36cf-fzyqqiq9722810.jpg" height="200px" width="150px" title="我是一个美女"/>
```
...
<a href="http://www.itheima.com" target="_blank">
    <前端assets src="前端assets/logo2.png">
</a>
```
...
- `<th>`标签用于定义表头。单元格内的内容默认居中、加粗。table heading
  ...
  ![1595563484651](前端assets/1595563484651.png)
...
![1595571548410](前端assets/1595571548410.png)
...
![1595572467557](前端assets/1595572467557.png)
    ...
    <form action="#" method="get">
        ...
        <!--
            ...
            属性:
                ...
                width:设置图片的宽度,单位像素
        -->
        <input type="image" src="前端assets/2.jpg" height="200px" width="170px"><br/>
        <!--
            - hidden:隐藏域,存储数据使用,不会在浏览器页面显示
...
![1595727041168](前端assets/1595727041168.png)
...
![1595728429518](前端assets/1595728429518.png)
...
![1595728454040](前端assets/1595728454040.png)
...
![1595731918780](前端assets/1595731918780.png)
...
<body>
    ...
    <前端assets style="display: none" src="前端assets/2.jpg" height="100px" width="80px">
</body>
</html>
```

![1595733367727](前端assets/1595733367727.png)
...
![1595733893766](前端assets/1595733893766.png)
...
<!--给整个body添加一个背景图片-->
<body style="background-image: url(前端assets/bg.jpg);background-repeat:no-repeat;background-position: top 30px right 100px">
    <!--给div添加一个背景色-->
...
![1595734682050](前端assets/1595734682050.png)

### CSS的盒子模型

![1595735842955](前端assets/1595735842955.png)
...
![1577560513351](前端assets/1577560513351.png)

案例需求分析

![1595743775393](前端assets/1595743775393.png)
...
![1577565301570](前端assets/1577565301570.png)

### 需求分析

![1595744779816](前端assets/1595744779816.png)
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <前端assets src="前端assets/checkCode.bmp">
                        </td>
                    </tr>
                    <tr>
...
![1595747936050](前端assets/1595747936050.png)

![1595747966444](前端assets/1595747966444.png)
...
![1595748269794](前端assets/1595748269794.png)
...
![1577653877699](前端assets/1577653877699.png)
...
![1577650047625](前端assets/1577650047625.png)
...
<body>
    ...
    <!--图片鼠标移入事件-->
    <前端assets src="前端assets/1.jpg" width="150px" height="200px" onmouseover="前端assetsOnmouseover()">
    <!--文本获取焦点事件-->
...
![1595986717137](前端assets/1595986717137-1596036966235.png)
...
![1595991003925](前端assets/1595991003925-1596036966235.png)
...
<head>
    ...
    <script>
        ...
        window.onload = function () {
            /*
                分析:
                    1.定义一个变量,记录图片的整数值前端assetsInt
                    2.创建一个反复执行的定时器,每隔3秒钟执行一次
                    3.判断图片的整数值前端assetsInt<3 前端assetsInt++; 否则 前端assetsInt=1
                    4.通过图片的id属性值获取图片对象
                    5.修改图片对象的src的属性值
             */
            //1.定义一个变量,记录图片的整数值前端assetsInt
            ...
            setInterval(function () {
                ...
                //4.通过图片的id属性值获取图片对象
                var 前端assetsAdELe = document.querySelector("#前端assetsAd");
                //5.修改图片对象的src的属性值
                前端assetsAdELe.src = "../前端assets/ad"+前端assetsInt+".jpg";
...
<body>
    <div style="width: 500px;margin: 50px auto">
        <前端assets id="前端assetsAd" src="../前端assets/ad1.jpg">
    </div>
</body>
</html>
...
![1572600617133](前端assets/1572600617133-1596036966236.png)
...
![1572602429296](前端assets/1572602429296-1596036966236.png)
	...
	<head>
		...
		<style type="text/css">
					.regist_bg {
						...
						height: 600px;
						padding-top: 40px;
						background-image: url(../前端assets/bg.jpg);
					}
					.regist {
				...
				<form action="#">
					<table width="600" height="350px">
						...
						<tr>
							...
							<td><前端assets src="../前端assets/checkCode.bmp" /> </td>
						</tr>
						<tr>
							<td></td>
							<td colspan="2">
...
<head>
    ...
    <script>
        $(function(){
            // 获取属性
            alert($("#前端assetss").attr("alt"));
            // 设置属性 覆盖/添加
            //$("#前端assetss").attr("width","500px");
            // 删除属性
            //$("#前端assetss").removeAttr("width");
        })
    </script>
...
<body>
    <前端assets src="../前端assets/12.jpg" alt="图片没要找到" width="300px" id="前端assetss" />
    <hr/>
